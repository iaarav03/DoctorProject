...
function About() {
    ...
    <div>
      ...
      <div className="mb-4 flex justify-center items-center">
        ...
        >
          ...
          <div className="h-96 bg-stone-200 min-w-full text-center">
  ...
  className={`${
    letter === 'A'
      ? "bg-custom-class-for-A bg-gradient-to-r from-cyan-500 to-blue-500 text-gray-800 py-2 px-4 rounded-md mx-1"
